...
impl U2f {
	...
	pub fn new(app_id:String) -> Self { U2f { app_id } }
	...
	pub fn sign_response(
		...
		match auth {
			Ok(ref res) => {
				// CounterTooLow is raised when the counter value received from
				// the device is lower than last stored counter value.
